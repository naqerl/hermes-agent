      ...
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content
          ...
          onCloseAutoFocus={event => {
            // Suppress Radix's default restoreFocus — Cmd+K is a global hotkey,
            // so document.activeElement at open-time is frequently the sidebar
            // or a non-composer element. Routing through the composer-focus bus
            // (which the composer already subscribes to) keeps focus on the
            // composer regardless of where it was when the palette opened.
